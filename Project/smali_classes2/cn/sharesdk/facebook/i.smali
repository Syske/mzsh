.class public Lcn/sharesdk/facebook/i;
...
.method static synthetic a(Lcn/sharesdk/facebook/i;)Lcn/sharesdk/framework/PlatformActionListener;
    .locals 1

    iget-object v0, p0, Lcn/sharesdk/facebook/i;->b:Lcn/sharesdk/framework/PlatformActionListener;

    return-object v0
.end method

.method static synthetic a(Lcn/sharesdk/facebook/i;Ljava/lang/String;)V
    .locals 0

    invoke-direct {p0, p1}, Lcn/sharesdk/facebook/i;->b(Ljava/lang/String;)V
...
.method private b()Lcn/sharesdk/facebook/a;
    ...
    :try_start_0
    iget-object v0, p0, Lcn/sharesdk/facebook/i;->activity:Landroid/app/Activity;

    invoke-virtual {v0}, Landroid/app/Activity;->getPackageManager()Landroid/content/pm/PackageManager;

    move-result-object v0

    iget-object v2, p0, Lcn/sharesdk/facebook/i;->activity:Landroid/app/Activity;
...
.method private b(Ljava/lang/String;)V
    ...
    iput-boolean v4, p0, Lcn/sharesdk/facebook/i;->f:Z

    invoke-virtual {p0}, Lcn/sharesdk/facebook/i;->finish()V

    iget-object v1, p0, Lcn/sharesdk/facebook/i;->b:Lcn/sharesdk/framework/PlatformActionListener;
    ...
    :cond_5
    iput-boolean v4, p0, Lcn/sharesdk/facebook/i;->g:Z
...
.method protected a()Lcn/sharesdk/framework/authorize/RegisterView;
    ...
    iget-object v1, p0, Lcn/sharesdk/facebook/i;->activity:Landroid/app/Activity;
    ...
    new-instance v2, Lcn/sharesdk/facebook/j;

    invoke-direct {v2, p0}, Lcn/sharesdk/facebook/j;-><init>(Lcn/sharesdk/facebook/i;)V
    ...
    iput-object v1, p0, Lcn/sharesdk/facebook/i;->e:Landroid/webkit/WebView;

    iget-object v1, p0, Lcn/sharesdk/facebook/i;->e:Landroid/webkit/WebView;
    ...
    new-instance v2, Lcn/sharesdk/facebook/l;

    invoke-direct {v2, p0}, Lcn/sharesdk/facebook/l;-><init>(Lcn/sharesdk/facebook/i;)V
...
.method public a(Lcn/sharesdk/framework/PlatformActionListener;)V
    ...
    iput-object p1, p0, Lcn/sharesdk/facebook/i;->b:Lcn/sharesdk/framework/PlatformActionListener;
...
.method public a(Ljava/lang/String;)V
    ...
    iput-object p1, p0, Lcn/sharesdk/facebook/i;->a:Ljava/lang/String;
...
.method public onCreate()V
    ...
    invoke-virtual {p0}, Lcn/sharesdk/facebook/i;->a()Lcn/sharesdk/framework/authorize/RegisterView;

    move-result-object v0

    iput-object v0, p0, Lcn/sharesdk/facebook/i;->d:Lcn/sharesdk/framework/authorize/RegisterView;

    :try_start_0
    invoke-virtual {p0}, Lcn/sharesdk/facebook/i;->getContext()Landroid/content/Context;
    ...
    iget-object v1, p0, Lcn/sharesdk/facebook/i;->d:Lcn/sharesdk/framework/authorize/RegisterView;
    ...
    :cond_0
    :goto_0
    iget-object v0, p0, Lcn/sharesdk/facebook/i;->c:Lcn/sharesdk/facebook/a;
    ...
    iput-boolean v0, p0, Lcn/sharesdk/facebook/i;->f:Z
    ...
    iget-object v0, p0, Lcn/sharesdk/facebook/i;->d:Lcn/sharesdk/framework/authorize/RegisterView;
    ...
    iget-object v1, p0, Lcn/sharesdk/facebook/i;->a:Ljava/lang/String;
...
.method public onDestroy()V
    ...
    iget-boolean v0, p0, Lcn/sharesdk/facebook/i;->f:Z

    if-nez v0, :cond_0

    iget-boolean v0, p0, Lcn/sharesdk/facebook/i;->g:Z
...
.method public setActivity(Landroid/app/Activity;)V
    ...
    invoke-direct {p0}, Lcn/sharesdk/facebook/i;->b()Lcn/sharesdk/facebook/a;

    move-result-object v0

    iput-object v0, p0, Lcn/sharesdk/facebook/i;->c:Lcn/sharesdk/facebook/a;
