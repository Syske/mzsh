...
.method static constructor <clinit>()V
    ...
    sput-object v1, Lcz/msebera/android/httpclient/impl/conn/CPoolProxy;->CLOSE_METHOD:Ljava/lang/reflect/Method;
    ...
    sput-object v1, Lcz/msebera/android/httpclient/impl/conn/CPoolProxy;->SHUTDOWN_METHOD:Ljava/lang/reflect/Method;
    ...
    sput-object v1, Lcz/msebera/android/httpclient/impl/conn/CPoolProxy;->IS_OPEN_METHOD:Ljava/lang/reflect/Method;
    ...
    sput-object v1, Lcz/msebera/android/httpclient/impl/conn/CPoolProxy;->IS_STALE_METHOD:Ljava/lang/reflect/Method;
    :try_end_0
...
.method public static detach(Lcz/msebera/android/httpclient/HttpClientConnection;)Lcz/msebera/android/httpclient/impl/conn/CPoolEntry;
    ...
    .prologue
    .line 176
    invoke-static {p0}, Lcz/msebera/android/httpclient/impl/conn/CPoolProxy;->getHandler(Lcz/msebera/android/httpclient/HttpClientConnection;)Lcz/msebera/android/httpclient/impl/conn/CPoolProxy;
...
.method private static getHandler(Lcz/msebera/android/httpclient/HttpClientConnection;)Lcz/msebera/android/httpclient/impl/conn/CPoolProxy;
    .locals 4
    .param p0, "proxy"    # Lcz/msebera/android/httpclient/HttpClientConnection;
    ...
    const-class v1, Lcz/msebera/android/httpclient/impl/conn/CPoolProxy;
    ...
    check-cast v1, Lcz/msebera/android/httpclient/impl/conn/CPoolProxy;
...
.method public static newProxy(Lcz/msebera/android/httpclient/impl/conn/CPoolEntry;)Lcz/msebera/android/httpclient/HttpClientConnection;
    ...
    const-class v3, Lcz/msebera/android/httpclient/conn/ManagedHttpClientConnection;

    aput-object v3, v1, v2

    const/4 v2, 0x1

    const-class v3, Lcz/msebera/android/httpclient/protocol/HttpContext;

    aput-object v3, v1, v2

    new-instance v2, Lcz/msebera/android/httpclient/impl/conn/CPoolProxy;

    invoke-direct {v2, p0}, Lcz/msebera/android/httpclient/impl/conn/CPoolProxy;-><init>(Lcz/msebera/android/httpclient/impl/conn/CPoolEntry;)V
...
.method getConnection()Lcz/msebera/android/httpclient/HttpClientConnection;
    .locals 2
    ...
    check-cast v1, Lcz/msebera/android/httpclient/HttpClientConnection;
...
.method public invoke(Ljava/lang/Object;Ljava/lang/reflect/Method;[Ljava/lang/Object;)Ljava/lang/Object;
    ...
    .line 122
    sget-object v4, Lcz/msebera/android/httpclient/impl/conn/CPoolProxy;->CLOSE_METHOD:Ljava/lang/reflect/Method;
    ...
    .line 123
    invoke-virtual {p0}, Lcz/msebera/android/httpclient/impl/conn/CPoolProxy;->close()V
    ...
    .line 125
    :cond_0
    sget-object v4, Lcz/msebera/android/httpclient/impl/conn/CPoolProxy;->SHUTDOWN_METHOD:Ljava/lang/reflect/Method;
    ...
    .line 126
    invoke-virtual {p0}, Lcz/msebera/android/httpclient/impl/conn/CPoolProxy;->shutdown()V

    goto :goto_0

    .line 128
    :cond_1
    sget-object v3, Lcz/msebera/android/httpclient/impl/conn/CPoolProxy;->IS_OPEN_METHOD:Ljava/lang/reflect/Method;
    ...
    .line 129
    invoke-virtual {p0}, Lcz/msebera/android/httpclient/impl/conn/CPoolProxy;->isOpen()Z
    ...
    .line 130
    :cond_2
    sget-object v3, Lcz/msebera/android/httpclient/impl/conn/CPoolProxy;->IS_STALE_METHOD:Ljava/lang/reflect/Method;
    ...
    .line 131
    invoke-virtual {p0}, Lcz/msebera/android/httpclient/impl/conn/CPoolProxy;->isStale()Z
    ...
    .line 133
    :cond_3
    invoke-virtual {p0}, Lcz/msebera/android/httpclient/impl/conn/CPoolProxy;->getConnection()Lcz/msebera/android/httpclient/HttpClientConnection;

    move-result-object v1

    .line 134
    .local v1, "conn":Lcz/msebera/android/httpclient/HttpClientConnection;
    if-nez v1, :cond_4
